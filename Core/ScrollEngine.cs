...
namespace FlowWheel.Core
{
    ...
    public class ScrollEngine
    {
        ...
        public void ApplyConfig(AppConfig config)
        {
            ...
            BreakSpeedLimit = config.BreakSpeedLimit;
            BreakSpeedLimitMax = config.BreakSpeedLimitMax;
        ...
        public double GetCurrentReadingSpeed()
        {
            lock (_lock)
            {
        ...
        {
            return BreakSpeedLimit ? BreakSpeedLimitMax : MaxScrollSpeed;
        }
        ...
        {
            _inputBuffer[0].type = NativeMethods.INPUT_MOUSE;
            _inputBuffer[0].mi = new NativeMethods.MOUSEINPUT
            {
                dx = 0,
                dy = 0,
